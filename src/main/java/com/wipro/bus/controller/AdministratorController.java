...
public class AdministratorController {
    ...
    @PostMapping("/create")
    public ResponseEntity<AdministratorDTO> createAdministrator(@Validated @RequestBody AdministratorDTO administratorDTO) {
    ...
    public ResponseEntity<AdministratorDTO> updateAdministrator(@PathVariable Long adminId, @Validated @RequestBody AdministratorDTO administratorDTO) {
